...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { active: @hour.active, business_id: @hour.business_id, day_id: @hour.day_id, time_end: @hour.time_end, time_start: @hour.time_start } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { active: @hour.active, business_id: @hour.business_id, day_id: @hour.day_id, time_end: @hour.time_end, time_start: @hour.time_start } }
