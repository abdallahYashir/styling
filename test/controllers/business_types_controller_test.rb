...
class BusinessTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_type" do
    assert_difference('BusinessType.count') do
      post business_types_url, params: { business_type: { description: @business_type.description, name: @business_type.name } }
    end
  ...
  test "should update business_type" do
    patch business_type_url(@business_type), params: { business_type: { description: @business_type.description, name: @business_type.name } }
