...
class WorkingHoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create working_hour" do
    assert_difference('WorkingHour.count') do
      post working_hours_url, params: { working_hour: { active: @working_hour.active, business_id: @working_hour.business_id, days_id: @working_hour.days_id, time_end: @working_hour.time_end, time_start: @working_hour.time_start } }
    end
  ...
  test "should update working_hour" do
    patch working_hour_url(@working_hour), params: { working_hour: { active: @working_hour.active, business_id: @working_hour.business_id, days_id: @working_hour.days_id, time_end: @working_hour.time_end, time_start: @working_hour.time_start } }
